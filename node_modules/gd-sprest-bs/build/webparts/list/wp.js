...
var WPList = function (props) {
    ...
    var loadCAML = function (caml) {
        ...
        if (webUrl) {
            ...
            gd_sprest_1.ContextInfo.getWeb(webUrl).execute(function (contextInfo) {
                // Get the web
                (0, gd_sprest_1.Web)(webUrl, { requestDigest: contextInfo.GetContextWebInformation.FormDigestValue })
                    // Get the list
    ...
    var loadODATA = function (query) {
        ...
        // Get the web
        (0, gd_sprest_1.Web)(_wpInfo.cfg.WebUrl)
            // Get the list
            .Lists(_wpInfo.cfg.ListName)
            // Get the items
            .Items()
    ...
    return (0, wp_1.WebPart)({
        cfgElementId: props.cfgElementId,
        className: props.className,
        editForm: (0, wpCfg_1.WPListEditForm)(props.editForm),
