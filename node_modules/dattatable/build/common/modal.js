...
var Modal = /** @class */ (function () {
    ...
    Modal.setBackdrop = function (value) { this._modal.setBackdrop(value); };
    // Sets the body
    ...
    Modal.setCloseButtonVisibility = function (showFl) { this._modal.setCloseButtonVisibility(showFl); };
    // Sets the close event
    Modal.setCloseEvent = function (event) { this._onCloseEvent = event; };
    // Sets the focus option
    Modal.setFocus = function (value) { this._modal.setFocus(value); };
    // Sets the footer
    ...
    Modal.setIsCentered = function (value) { this._modal.setIsCentered(value); };
    // Sets the keyboard option
    Modal.setKeyboard = function (value) { this._modal.setKeyboard(value); };
    // Sets the scrollable option
    Modal.setScrollable = function (value) { this._modal.setScrollable(value); };
    // Sets the modal type
